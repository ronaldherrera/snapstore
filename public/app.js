...
function showWarning(msg) {
  ...
  el.innerHTML = `<span>${msg}</span>
    <a href="https://github.com/ronaldherrera/snapstore/releases/latest/download/SnapStore%20Setup%201.0.0.exe" target="_blank" rel="noopener" class="warning-download-btn">
